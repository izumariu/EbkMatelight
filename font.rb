# source: https://github.com/FMMT666/launchpad.py/blob/master/launchpad_charset.py
...
$CHARTAB = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  # Char 000 (.)
            ...
            0x5a, 0x3c, 0x66, 0x66, 0x7e, 0x66, 0x66, 0x00,  # Char 196 (.)
            ...
            0x00, 0x00, 0x3C, 0x06, 0x3E, 0x66, 0x3A, 0x00,  # Char 223 (.)
            ...
            0x24, 0x00, 0x3C, 0x06, 0x3E, 0x66, 0x3A, 0x00,  # Char 229 (.)
...
def getFontChar(c)
  chrbuf=[]
  8.times{|i|
    chrbuf.push($CHARTAB[c.ord*8+i])
  }
  return chrbuf
end

# def encrypt(s);print "[";print s.map{|i|"0x"<<("%02x"%i.to_i(2))}.join(", ");puts "]";end
# def decrypt(s);return s.map{|i|"%08b"%i}end
